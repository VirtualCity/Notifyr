    ...
    <div class="tab-pane fade active in" id="default-tab-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table id="approvedsmsdatatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                        <tr>
                            <th>group</th>
                            <th>contacts</th>
...
<script type="text/javascript">
   $(document).ready(function(){
        ...
        <?php endif; ?>
        $('#approvedsmsdatatables').DataTable({
                dom: 'B<"clear">lfrtip',
