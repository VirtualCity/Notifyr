        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                <div class="well-header">
                    <h5>Email Weekly Report to Area Sales Managers</h5>
                </div>
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('reports/managers/mail')?>" method="post"  class="form-horizontal">
                        ...
                        <div class="form_row">
                            <div class="well">
                                <div class="well-content no_search">
                                <span class="lblBold">Click on the button below to email Area Sales Managers, a weekly purchase reports by stockists from their respective regions.</span>
                                </div>
                            </div>
