...
<div id="content" class="content">
    ...
    <div id="alert_placeholder">
        ...
        if(!empty($appmsg)){ ?>
        <div id="alertdiv" class="alert <?=$this->session->flashdata('alert_type') ?> "><a class="close"
                data-dismiss="alert">x</a><span><?= $appmsg ?></span></div>
        <?php } ?>
    </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="<?=base_url('managers/do_upload')?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-6">
                                ...
                                <a href="<?php echo base_url().'managers/download'; ?>" class="btn btn-primary"><i
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <br>
                            <br>
                            <button type="submit" name="submit" class="btn btn-primary" onclick="checkFile()"><i
