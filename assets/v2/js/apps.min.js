/*
Template Name: Controllr - Responsive Admin Dashboard Template build with Twitter Bootstrap 3.3.7
Version: 2.1.0
Author: Charles Wahome
Github: thewahome
*/
var handleSlimScroll = function() {
        "use strict";
        $("[data-scrollbar=true]").each(function() { generateSlimScroll($(this)) })
    },
    generateSlimScroll = function(a) {
        if (!$(a).attr("data-init")) {
            var b = $(a).attr("data-height");
            b = b ? b : $(a).height();
            var c = { height: b, alwaysVisible: !0 };
    ...
    handleSidebarMenu = function() {
        ...
        $(".sidebar .nav > .has-sub > a").click(function() {
            ...
            0 === $(".page-sidebar-minified").length && ($(b).not(a).slideUp(250, function() { $(this).closest("li").removeClass("expand") }), $(a).slideToggle(250, function() {
    ...
    handleMobileSidebarToggle = function() {
        var a = !1;
        $(".sidebar").bind("click touchstart", function(b) { 0 !== $(b.target).closest(".sidebar").length ? a = !0 : (a = !1, b.stopPropagation()) }), $(document).bind("click touchstart", function(b) { 0 === $(b.target).closest(".sidebar").length && (a = !1), b.isPropagationStopped() || a === !0 || ($("#page-container").hasClass("page-sidebar-toggled") && (a = !0, $("#page-container").removeClass("page-sidebar-toggled")), $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (a = !0, $("#page-container").removeClass("page-right-sidebar-toggled"))) }), $("[data-click=right-sidebar-toggled]").click(function(b) {
            b.stopPropagation();
    ...
    handleSidebarMinify = function() {
        $("[data-click=sidebar-minify]").click(function(a) {
            ...
            $('#sidebar [data-scrollbar="true"]').css("margin-top", "0"),
                ...
                $(c).hasClass(b) ? ($(c).removeClass(b), 
                    $(c).hasClass("page-sidebar-fixed") ? (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({ destroy: !0 }), 
                        $('#sidebar [data-scrollbar="true"]').removeAttr("style")), 
                    generateSlimScroll($('#sidebar [data-scrollbar="true"]')), 
                    $("#sidebar [data-scrollbar=true]").trigger("mouseover")) : /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({ destroy: !0 }), 
                        $('#sidebar [data-scrollbar="true"]').removeAttr("style")),
                    generateSlimScroll($('#sidebar [data-scrollbar="true"]')))) : ($(c).addClass(b), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? ($('#sidebar [data-scrollbar="true"]').css("margin-top", "0"), 
                    $('#sidebar [data-scrollbar="true"]').css("overflow", "visible")) : ($(c).hasClass("page-sidebar-fixed") && ($('#sidebar [data-scrollbar="true"]').slimScroll({ destroy: !0 }), $('#sidebar [data-scrollbar="true"]').removeAttr("style")), $("#sidebar [data-scrollbar=true]").trigger("mouseover"))), $(window).trigger("resize")
        })
    },
    ...
    handlePanelAction = function() {
        "use strict";
        return !panelActionRunning && (panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function(a) { $(this).attr("data-init") || ($(this).tooltip({ title: "Remove", placement: "bottom", trigger: "hover", container: "body" }), $(this).tooltip("show"), $(this).attr("data-init", !0)) }), $(document).on("click", "[data-click=panel-remove]", function(a) { a.preventDefault(), $(this).tooltip("destroy"), $(this).closest(".panel").remove() }), $(document).on("hover", "[data-click=panel-collapse]", function(a) { $(this).attr("data-init") || ($(this).tooltip({ title: "Collapse / Expand", placement: "bottom", trigger: "hover", container: "body" }), $(this).tooltip("show"), $(this).attr("data-init", !0)) }), $(document).on("click", "[data-click=panel-collapse]", function(a) { a.preventDefault(), $(this).closest(".panel").find(".panel-body").slideToggle() }), $(document).on("hover", "[data-click=panel-reload]", function(a) { $(this).attr("data-init") || ($(this).tooltip({ title: "Reload", placement: "bottom", trigger: "hover", container: "body" }), $(this).tooltip("show"), $(this).attr("data-init", !0)) }), $(document).on("click", "[data-click=panel-reload]", function(a) {
            a.preventDefault();
        ...
        }), $(document).on("hover", "[data-click=panel-expand]", function(a) { $(this).attr("data-init") || ($(this).tooltip({ title: "Expand / Compress", placement: "bottom", trigger: "hover", container: "body" }), $(this).tooltip("show"), $(this).attr("data-init", !0)) }), void $(document).on("click", "[data-click=panel-expand]", function(a) {
            a.preventDefault();
            var b = $(this).closest(".panel"),
                c = $(b).find(".panel-body"),
                d = 40;
    ...
    handleDraggablePanel = function() {
        ...
        var a = $(".panel").parent("[class*=col]"),
            b = ".panel-heading",
            c = ".row > [class*=col]";
        $(a).sortable({ handle: b, connectWith: c, stop: function(a, b) { b.item.find(".panel-title").append('<i class="fa fa-refresh fa-spin m-l-5" data-id="title-spinner"></i>'), handleSavePanelPosition(b.item) } })
    },
    ...
    handleScrollToTopButton = function() {
        ...
        }), $("[data-click=scroll-top]").click(function(a) { a.preventDefault(), $("html, body").animate({ scrollTop: $("body").offset().top }, 500) })
    },
    handleThemePageStructureControl = function() {
        ...
        $.cookie && $.cookie("sidebar-styling") && 0 !== $(".sidebar").length && "grid" == $.cookie("sidebar-styling") && ($(".sidebar").addClass("sidebar-grid"), $('[name=sidebar-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("header-styling") && 0 !== $(".header").length && "navbar-inverse" == $.cookie("header-styling") && ($(".header").addClass("navbar-inverse"), $('[name=header-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("content-gradient") && 0 !== $("#page-container").length && "enabled" == $.cookie("content-gradient") && ($("#page-container").addClass("gradient-enabled"), $('[name=content-gradient] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("content-styling") && 0 !== $("body").length && "black" == $.cookie("content-styling") && ($("body").addClass("flat-black"), $('[name=content-styling] option[value="2"]').prop("selected", !0)), $(".theme-list [data-theme]").click(function() {
            ...
            }) : $(window).width() > 979 && ($('.sidebar [data-scrollbar="true"]').slimScroll({ destroy: !0 }), $('.sidebar [data-scrollbar="true"]').removeAttr("style"))), 0 === $("#page-container .sidebar-bg").length && $("#page-container").append('<div class="sidebar-bg"></div>'))
    ...
    handleSavePanelPosition = function(a) {
        ...
        if (0 !== $(".ui-sortable").length) {
            ...
            $.when($(".ui-sortable").each(function() {
                ...
                c = c.split("?"), c = c[0], localStorage.setItem(c, JSON.stringify(b)), $(a).find('[data-id="title-spinner"]').delay(500).fadeOut(500, function() { $(this).remove() })
            })
        }
    },
    ...
    handleResetLocalStorage = function() {
        ...
        }), $(document).on("hidden.bs.modal", '[data-modal-id="reset-local-storage-confirmation"]', function(a) { $('[data-modal-id="reset-local-storage-confirmation"]').remove() }), $(document).on("click", "[data-click=confirm-reset-local-storage]", function(a) {
            a.preventDefault();
    ...
    handleUnlimitedTabsRender = function() {
        function a(a, b) {
            var d = (parseInt($(a).css("margin-left")), $(a).width()),
                ...
                f = b > -1 ? b : 150,
                g = 0;
            if ($(a).find("li.active").prevAll().each(function() { e += $(this).width() }), $(a).find("li").each(function() { g += $(this).width() }), e >= d) {
                var h = e - d;
                g != e && (h += 40), $(a).find(".nav.nav-tabs").animate({ marginLeft: "-" + h + "px" }, f)
            }
        ...
        function b(a, b) {
            var c = $(a).closest(".tab-overflow"),
                ...
                f = 0,
                g = 0;
            switch ($(c).find("li").each(function() { $(this).hasClass("next-button") || $(this).hasClass("prev-button") || (f += $(this).width()) }), b) {
                case "next":
                    var h = f + d - e;
                    h <= e ? (g = h - d, setTimeout(function() { $(c).removeClass("overflow-right") }, 150)) : g = e - d - 80, 0 != g && $(c).find(".nav.nav-tabs").animate({ marginLeft: "-" + g + "px" }, 150, function() { $(c).addClass("overflow-left") });
                    break;
                case "prev":
                    var h = -d;
                    h <= e ? ($(c).removeClass("overflow-left"), g = 0) : g = h - e + 80, $(c).find(".nav.nav-tabs").animate({ marginLeft: "-" + g + "px" }, 150, function() { $(c).addClass("overflow-right") })
            }
        }
        ...
        $('[data-click="next-tab"]').click(function(a) { a.preventDefault(), b(this, "next") }), $('[data-click="prev-tab"]').click(function(a) { a.preventDefault(), b(this, "prev") }), $(window).resize(function() { $(".tab-overflow .nav.nav-tabs").removeAttr("style"), c() }), c()
    },
    handleMobileSidebar = function() {
        "use strict";
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && $("#page-container").hasClass("page-sidebar-minified") && ($('#sidebar [data-scrollbar="true"]').css("overflow", "visible"), $('.page-sidebar-minified #sidebar [data-scrollbar="true"]').slimScroll({ destroy: !0 }), $('.page-sidebar-minified #sidebar [data-scrollbar="true"]').removeAttr("style"), $(".page-sidebar-minified #sidebar [data-scrollbar=true]").trigger("mouseover"));
        var a = 0;
        $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function(b) {
            ...
            a = $(c).css("margin-top");
            var g = e;
            $(".sidebar").not(".sidebar-right").find(".nav").each(function() { g += $(this).height() });
            var h = -parseInt(a) + $(".sidebar").height();
            if (h >= g && d <= g && f <= g) {
                var i = d - g - 20;
                $(c).animate({ marginTop: i + "px" })
            } else parseInt(a) >= 0 || f >= g ? $(c).animate({ marginTop: "0px" }) : (i = a, $(c).animate({ marginTop: i + "px" }))
        })
    },
    handleUnlimitedTopMenuRender = function() {
        ...
        function a(a, b) {
            var c = $(a).closest(".nav"),
                ...
                f = 0,
                g = 0;
            switch ($(c).find("li").each(function() { $(this).hasClass("menu-control") || (f += $(this).width()) }), b) {
                case "next":
                    var h = f + d - e;
                    h <= e ? (g = h - d + 128, setTimeout(function() { $(c).find(".menu-control.menu-control-right").removeClass("show") }, 150)) : g = e - d - 128, 0 != g && $(c).animate({ marginLeft: "-" + g + "px" }, 150, function() { $(c).find(".menu-control.menu-control-left").addClass("show") });
                    break;
                case "prev":
                    var h = -d;
                    h <= e ? ($(c).find(".menu-control.menu-control-left").removeClass("show"), g = 0) : g = h - e + 88, $(c).animate({ marginLeft: "-" + g + "px" }, 150, function() { $(c).find(".menu-control.menu-control-right").addClass("show") })
            }
        }
        ...
        function b() {
            var a = $(".top-menu .nav"),
                ...
                h = 0,
                i = 0;
            if ($(c).prevAll().each(function() { g += $(this).width() }), $(b).each(function() { $(this).hasClass("menu-control") || (i += $(this).width()) }), g >= f) {
                var j = g - f + 128;
                $(a).animate({ marginLeft: "-" + j + "px" }, h)
            }
        ...
        $('[data-click="next-menu"]').click(function(b) { b.preventDefault(), a(this, "next") }), $('[data-click="prev-menu"]').click(function(b) { b.preventDefault(), a(this, "prev") }), $(window).resize(function() { $(".top-menu .nav").removeAttr("style"), b() }), b()
    },
    handleTopMenuSubMenu = function() {
        ...
        $(".top-menu .sub-menu .has-sub > a").click(function() {
            ...
            $(b).not(a).slideUp(250, function() { $(this).closest("li").removeClass("expand") }), $(a).slideToggle(250, function() {
                var a = $(this).closest("li");
                $(a).hasClass("expand") ? $(a).removeClass("expand") : $(a).addClass("expand")
            })
        })
    ...
    handleTopMenuMobileToggle = function() {
        "use strict";
        $('[data-click="top-menu-toggled"]').click(function() { $(".top-menu").slideToggle(250) })
    },
    handleClearSidebarSelection = function() { $(".sidebar .nav > li, .sidebar .nav .sub-menu").removeClass("expand").removeAttr("style") },
    handleClearSidebarMobileSelection = function() { $("#page-container").removeClass("page-sidebar-toggled") },
    App = function() {
        "use strict";
